...
<h2><a href="selectfaculty.jsp">  <img src="back.png" width="42" height="42"/></a></h2>
<%@page import="com.dto.Teacher"%> 
<%@page import="Database.Util"%> 
<%@page import="java.sql.*" %>
<%
String email=request.getParameter("email");
String sql1="(select * from feedback where faculty_email='"+email+"')";
String sql2="(select * from teacher where email='"+email+"')";
try(Connection con=Util.getConnection();
	...
	if(b==false)
	{
		out.println("<h3> Email does not exist</h3>");
	}
	else
	{
	...
	if(!isNull)
	{
		out.println("<h3 style='color:blue;'>Find your Feedback.</h3>");
	}
	else
	{
		out.println("<h3 style='color:blue;'>Feedback is not given yet.</h3>");
	}
	}
	} catch(Exception ex)
		{
