...
<form action="StudentLoginOperation" onsubmit="return validate5();" method ="post" >
<div class="container">
    <div class="input-group">
    <span class="input-group-addon"><t1 class="glyphicon glyphicon-user"></t1></span>
       <input type="text" name="regino" class="form-control" id="t1" placeholder="Registration No">
    </div>
    <div class="input-group">
	  ...
	  <input type="submit" class="btn btn-primary" name="Login" value="Login" >
	   <a href="changestudentpassword.jsp"><input type="button" class="btn btn-primary" name="Cancel" value="Forgot Password"></a>
</div>
</form>	   
