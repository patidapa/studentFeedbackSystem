...
out.print("<b>"+name+"</b>");  
	...
	%>
<body class="body">
<h1><center>All Faculties Feedback Report</center> </h1>
<h2><a href="adminoption.jsp"> <img src="back.png" width="42" height="42"/></a></h2>
...
try(Connection con=Util.getConnection();
	...
	if(rs==null)
	{
		out.println("<b>  Feedback is not given yet.</b>");
	}
	%>
	<div id="table1">
